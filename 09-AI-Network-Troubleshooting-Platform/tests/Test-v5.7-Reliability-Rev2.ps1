...
Write-Host ""
Write-Host "================================================="
Write-Host " NETOPS v5.7 REV.2 RELIABILITY REGRESSION TESTS"
Write-Host "================================================="


# ============================================================
# TEST 1 - IPv6 DEFAULT ROUTE / GATEWAY
# ============================================================
...
Test-Result `
    "GRE decision is FIX" `
    ($result2 -match '(?is)DECISION.*?\bFIX\b')


# ============================================================
# TEST 3 - VLAN + DHCP MULTIPLE PROBLEMS
# ============================================================
...
Write-Host ""
Write-Host "NETOPS v5.7 RELIABILITY PATCH REV.2: READY" -ForegroundColor Green
